/*
This is a helper class designed to be used with the JUCE library.

It is mostly a wrapper around the AbstractFifo class that also includes its own
memory storage and some helpful functions.
*/
